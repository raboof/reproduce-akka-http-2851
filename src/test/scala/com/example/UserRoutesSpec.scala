...
//#set-up
class UserRoutesSpec extends WordSpec with Matchers with ScalaFutures with ScalatestRouteTest with ScalatestUtils {
  //#test-top
  ...
  "UserRoutes" should {
    "return no users if no present (GET /users)" in {
      ...
      Future.successful("1234") should evaluateTo[String]("asdf")
